...
<?php
        ...
        $product_img_link = wp_get_attachment_url($product->get_image_id());
        ?>
<td class="order-list__column-image">
    <div class="product-image">
        <a href="" class="product-image__body">
            <img class="product-image__img" src="<?php echo $product_img_link; ?>" alt="">
        </a>
    </div>
</td>
	<td class="order-list__column-product woocommerce-table__product-name product-name">
       <?php
